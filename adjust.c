/* ***************************************************************
 *
 * $Source: /pv/CvsTree/pv/gen/src/prg/methods/DtiEpi/adjust.c,v $
 *
 * Copyright (c) 2006
 ...
 *
 *
 * $Id: adjust.c,v 1.1.2.15 2010/03/05 14:28:20 dgem Exp $
 *
 * ***************************************************************/
...
static void setRGGhostAdj(YesNo);
static void setTrajAdj(void);
  ...
  switch(PTB_GetAdjCategory())
  {
    ...
    case USERADJ2:
         ...
         !strcmp(PTB_GetAdjName(),"EpiGrappa"))
      {
        ...
        */
        ParxRelsParSetEnumValueFromInt("PVM_DwMeasMode",0);
        PVM_DwAoImages = 0;
        PVM_DwNDiffExpEach = 1;
        PVM_DwNDiffDir=1;
        PVM_DwBvalEach[0] = 100;
...
/*
 *  This function is called each time an adjustment is finished. Changes made her
 *  will stay for the active scan.
 */
...
static void setRGGhostAdj(YesNo DoubleShot)
{
