...
L=[20]/100; %the readout, phase, slice
...
for iMBIndex =1:length(MBFraction)
    ...
    FileName=['SLR_BWe' num2str(BWePerMB)  'G_' num2str(sliceSeleRFParams.Gmax/gammaHz/100) '_' 'theta_' .....
        num2str(sliceSeleRFParams.theta) '_length' num2str(duration_lobe) '.RF' ];
