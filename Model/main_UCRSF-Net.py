...
def main():
    ...
    with h5py.File('data/train/mice_simult_train_std.mat', "r") as f:
        for key in f.keys():
    ...
    # vali_set = h5py.File(
    #     'data/validate/mice_simult_data3_x2_validate_std.mat')[
    #     'output'].value
    ...
    # create base for BPM module
    ImagX = train_set.shape[2]
    ...
    for iLever in range(8):
        if (iLever == 0):
            ...
            current_support = np.round(3 * current_support / 4 + 0.0001)
    ...
    train_loader = torch.utils.data.DataLoader(
        ...
        num_workers=args.workers, pin_memory=True, shuffle=True)#works
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch % 300 == 0:
            ...
            np.save("./%s/lossall_train2.npy" % (loss_dir), loss1)
